...
Для использования библиотеки к задаче сегментации хирургических инструментов на эндосокпических изображениях были использованы данные BinarySegmentation из [Robotic Instrument Segmentation challenge](https://endovissub2017-roboticinstrumentsegmentation.grand-challenge.org). 
