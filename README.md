...
Веса обученной модели расположены по ссылке, указанной в файле `model/checkpoints/saved_checkpoints/weights_link_dwnld.txt` по прямой [ссылке](https://drive.google.com/drive/folders/1AUc4VuqFIB-zN36ifnjZCO9nlPXAdfbF?usp=share_link).
