...
Веса обученной модели расположены по ссылке, указанной в файле `model/checkpoints/saved_checkpoints/weights_link_dwnld.txt` и по прямой [ссылке](https://drive.google.com/drive/folders/1AUc4VuqFIB-zN36ifnjZCO9nlPXAdfbF?usp=share_link).
...
В связи с ограничением доступа к исходному источнику, необходимые данные были взяты с сайта [Kaggle](https://www.kaggle.com/datasets/aithammadiabdellatif/binarysegmentation-endovis-17).
